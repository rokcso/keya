  ...
  "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-md text-sm font-medium transition-colors duration-150 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent-bright disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        ghost: "bg-white/[0.02] text-ink-secondary border border-white/[0.08] hover:bg-white/[0.05] hover:text-ink-primary",
        destructive: "bg-danger text-white hover:bg-danger/90",
        outline: "border border-white/[0.08] bg-transparent text-ink-secondary hover:bg-white/[0.04] hover:text-ink-primary",
        secondary: "bg-white/[0.04] text-ink-secondary hover:bg-white/[0.06] hover:text-ink-primary",
