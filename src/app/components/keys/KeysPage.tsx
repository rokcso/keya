  ...
  return (
    <div className="flex flex-1 min-h-0">
      <div className="flex-1 min-w-0 px-6 py-5 overflow-y-auto">
        {/* Center wrapper: uses flexbox centering + transform shift when detail opens */}
        <div className={`flex justify-center transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${selectedKeyId ? "-translate-x-16" : ""}`}>
