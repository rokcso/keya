...
export function KeysPage() {
  ...
  if (searchQuery) tags.push({ label: `"${searchQuery}"`, onRemove: () => setSearchQuery('') })
  if (filterGroupId) {
    const name = filterGroupId === '__ungrouped__' ? 'Ungrouped' : groups.find((g) => g.id === filterGroupId)?.name
