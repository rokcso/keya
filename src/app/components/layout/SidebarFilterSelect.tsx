...
export function SidebarFilterSelect({ value, onChange, options, placeholder }: Props) {
  // Find the display label for current value
  const displayLabel = value === null ? placeholder : options.find((o) => o.value === value)?.label
